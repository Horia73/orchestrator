...
type ChatEventBase =
    ...
    | { type: 'chat_followup_queued'; payload: { conversationId: string; followUpId: string; userMessageId: string; source: 'user' | 'background-job' | 'async-delegation'; queuedAt: number } }
