export const BROWSER_AGENT_CAPABILITY_HINT = [
    ...
    'can run browser_session_mode="incognito" through delegate_to for logged-out/private checks with a temporary isolated profile and no saved cookies/logins/localStorage',
