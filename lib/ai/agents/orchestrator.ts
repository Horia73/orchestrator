...
export const orchestrator: AgentConfig = {
    ...
    tools: [...DELEGATING_WORKSPACE_TOOLS, ...SCHEDULING_TOOL_IDS, ...OBSERVABILITY_TOOL_IDS, ...WATCHLIST_TOOL_IDS, ...MONITORING_TOOL_IDS, ...MICROSCRIPT_TOOL_IDS, ...MAPS_TOOL_IDS, ...WEATHER_TOOL_IDS, ...INTEGRATION_CONTROL_TOOL_IDS, ...GMAIL_TOOL_IDS, ...WHATSAPP_TOOL_IDS, ...GOOGLE_CALENDAR_TOOL_IDS, ...GOOGLE_DRIVE_TOOL_IDS, ...GOOGLE_CONTACTS_TOOL_IDS, ...GOOGLE_DOCS_TOOL_IDS, ...GOOGLE_SHEETS_TOOL_IDS, ...GOOGLE_SLIDES_TOOL_IDS, ...HOME_ASSISTANT_TOOL_IDS],
