...
import { CLI_WORKSPACE_BUILTINS, DELEGATING_WORKSPACE_TOOLS, GOOGLE_CONTACTS_TOOL_IDS, GOOGLE_DOCS_TOOL_IDS, GOOGLE_DRIVE_TOOL_IDS, GOOGLE_SHEETS_TOOL_IDS, GOOGLE_SLIDES_TOOL_IDS, INTEGRATION_CONTROL_TOOL_IDS, SKILL_TOOL_IDS } from './builtins'
...
export const worker: AgentConfig = {
    ...
    tools: [...DELEGATING_WORKSPACE_TOOLS, ...SKILL_TOOL_IDS, ...INTEGRATION_CONTROL_TOOL_IDS, ...GOOGLE_DRIVE_TOOL_IDS, ...GOOGLE_CONTACTS_TOOL_IDS, ...GOOGLE_DOCS_TOOL_IDS, ...GOOGLE_SHEETS_TOOL_IDS, ...GOOGLE_SLIDES_TOOL_IDS],
