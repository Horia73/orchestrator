...
export const bashTool: ToolDef = {
    ...
    description: [
        ...
        'Runtime environment: a Debian-based container with node, git, curl, jq, sqlite3, ripgrep (rg), grep, poppler-utils (pdftotext), ffmpeg, and imagemagick available. For searching file contents prefer the dedicated Grep tool over shelling out to rg/grep.',
