 ...
 *
 * The corresponding provider reads from this registry so that adjusting
 * subcommands or parsing rules is a one-file change.
 */
...
export interface CliStatus {
    ...
    expiresAt?: number
    /**
     * How the user is currently authenticated.
     */
...
export interface CliSpec {
     ...
     */
    loginHint: string
    /** Args for the interactive login subcommand. */
    loginArgs: string[]
...
export const CLI_SPECS: Record<CliId, CliSpec> = {
    'codex': {
        ...
        name: 'Codex CLI',
        bin: 'codex',
        description: 'OpenAI Codex CLI subscription. Used for coding tasks.',
        installBin: 'npm',
