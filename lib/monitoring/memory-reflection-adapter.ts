...
export const REFLECTION_PROMPT = [
  'Role: Run the scheduled nightly Memory reflection as silent background housekeeping, not as a user request.',
  '',
  'Goal: Keep durable memory accurate, compact, correctly tiered, and useful to both interactive and autonomous runs without changing raw daily audit files.',
  '',
  'Success criteria: every hot file is within budget; duplicates/conflicts/stale entries are resolved conservatively; autonomous-run facts remain hot; recurring procedures and monitor learnings are curated; no notification is sent except for a newly created playbook.',
  '',
