...
const REFLECTION_PROMPT = [
  ...
  '2. Read your durable memory (USER.md, MEMORY.md, MONITORS.md, PLAYBOOKS.md) and the recent daily working memory already in your context. Also read MEMORY_ARCHIVE.md (it is NOT auto-loaded) before you reorganize the hot/cold split.',
