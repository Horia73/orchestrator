...
export const WORKSPACE_FILE_DEFINITIONS: WorkspaceFileDefinition[] = [
  ...
  },
  {
    ...
    surface: "editor",
    description:
      "Assistant identity, self-knowledge, operating boundaries, and discoveries from onboarding.",
    defaultContent: [
      "# IDENTITY",
      "",
  ...
  },
  {
    ...
    defaultContent: [
      ...
      "6. Store confirmation preferences, browser-agent profile preferences, and service-specific exceptions as non-secret memory only; never store passwords, 2FA, recovery codes, cookies, or API key values in markdown.",
  ...
  },
  {
    ...
    surface: "editor",
    description:
      "Proactive monitoring preferences, candidate monitor specs, and active scheduled task ids.",
    defaultContent: [
      "# MONITORS",
      "",
