  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          "fixed inset-y-0 z-30 hidden h-svh w-(--sidebar-width) transition-[left,right,width] will-change-[left,right,width] data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex",
          SIDEBAR_TRANSITION,
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full touch-manipulation items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-10 text-[15px] md:h-8 md:text-sm",
...
function getSidebarMenuButtonTooltipLabel(
  tooltip: SidebarMenuButtonTooltip | undefined
): string | undefined {
  if (!tooltip) return undefined
  if (typeof tooltip === "string") return tooltip
  return typeof tooltip.children === "string" ? tooltip.children : undefined
}
...
function SidebarMenuButton({
  ...
  const tooltipLabel = getSidebarMenuButtonTooltipLabel(tooltip)
