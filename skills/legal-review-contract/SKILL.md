...
Before substantive work, activate `legal-workflow-core` and follow its shared evidence, jurisdiction, connector, authorization, and counsel-review contract. This skill defines only the domain workflow and deliverable.
...
Review the contract the user has provided in this conversation (uploaded file, pasted text, or a Library/uploads reference). If none is attached, ask for it.
