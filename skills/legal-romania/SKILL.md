---
name: legal-romania
description: Apply Romanian civil, labor, tax, privacy, consumer, e-signature, regulatory, energy/BESS, fundraising, and web/AI law to bundled legal workflows. Use when Romania/România is the jurisdiction, a party is an SRL/PFA/microîntreprindere, the document is Romanian, or the task mentions ANAF, ANRE, ASF, GDPR Romania, fiscal optimization, non-competes, investors/crowdfunding, BESS, AI Act, DPA, accessibility, or aggressive-but-lawful grey-zone options.
