...
Read this file when the user requests STL, 3MF, or native GLB output from CAD geometry. 2D DXF output is not installed in this runtime; offer STEP/STL/3MF instead.
