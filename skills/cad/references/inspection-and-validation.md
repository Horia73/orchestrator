...
- Visual review: `application/vnd.ant.cad` viewer artifact emitted; CAD `scripts/snapshot` PNG/GIF reviewed or skipped with reason; follow-up geometry checks for any visual findings
```
