...
const files: Array<{ path: string; content: string; resetByDefault: boolean }> = [
    ...
    },
    {
        ...
        content: [
            ...
            '6. Store browser-agent autonomy/profile preferences as non-secret memory only; never store passwords, 2FA, recovery codes, cookies, or API key values in markdown.',
