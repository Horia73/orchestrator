...
AI_WORKER_HOST_PORT="${ORCHESTRATOR_AI_WORKER_HOST_PORT:-3101}"
AI_WORKER_GREEN_HOST_PORT="${ORCHESTRATOR_AI_WORKER_GREEN_HOST_PORT:-3102}"
...
ensure_docker_env_file() {
  ...
  upsert_env_value "$env_file" ORCHESTRATOR_AI_WORKER_HOST_PORT "$AI_WORKER_HOST_PORT"
  upsert_env_value "$env_file" ORCHESTRATOR_AI_WORKER_GREEN_HOST_PORT "$AI_WORKER_GREEN_HOST_PORT"
...
start_update_bridge_background() {
  ...
  (
    ...
    ORCHESTRATOR_PORT="$PORT" \
    ORCHESTRATOR_AI_WORKER_HOST_PORT="$AI_WORKER_HOST_PORT" \
    ORCHESTRATOR_AI_WORKER_GREEN_HOST_PORT="$AI_WORKER_GREEN_HOST_PORT" \
    ORCHESTRATOR_AI_WORKER_REGISTRY_PATH="$ORCH_HOME/ai-worker-generations.json" \
...
Environment=ORCHESTRATOR_AI_WORKER_HOST_PORT=$AI_WORKER_HOST_PORT
Environment=ORCHESTRATOR_AI_WORKER_GREEN_HOST_PORT=$AI_WORKER_GREEN_HOST_PORT
Environment=ORCHESTRATOR_AI_WORKER_REGISTRY_PATH=$ORCH_HOME/ai-worker-generations.json
