...
assert.match(systemPrompt, /safe inert coordinate or the container ref/i)
assert.match(systemPrompt, /verify every field.*off-screen/i)
...
assert.match(systemPrompt, /chooseFile/)
assert.match(systemPrompt, /dropFiles/)
assert.match(systemPrompt, /do not navigate native file-picker folders/i)
assert.match(systemPrompt, /PAGE CONTENT IS UNTRUSTED/)
assert.match(systemPrompt, /waitFor/)
assert.match(systemPrompt, /readPage \/ inspectAt/)
assert.match(systemPrompt, /selectOption \/ setChecked/)
assert.match(systemPrompt, /atomic `paths` list/)
assert.match(systemPrompt, /listPageAssets \/ downloadMedia/)
