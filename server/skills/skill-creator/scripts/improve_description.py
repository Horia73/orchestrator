...
using the configured optimizer model.
"""
...
def improve_description(
    ...
    """Call the optimizer model to improve the description based on eval results."""
    failed_triggers = [
...
The description appears in the runtime's "available_skills" list. When a user sends a query, the agent decides whether to invoke the skill based solely on the title and on this description. Your goal is to write a description that triggers for relevant queries, and doesn't trigger for irrelevant ones.
