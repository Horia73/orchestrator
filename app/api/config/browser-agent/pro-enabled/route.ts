...
import { proxyToAllDurableAiWorkers, shouldProxyToDurableAiWorker } from '@/lib/ai/durable-worker'
...
export async function PUT(request: Request) {
  return runWithRequestProfile(request, async () => {
        ...
        if (shouldProxyToDurableAiWorker()) return proxyToAllDurableAiWorkers(request)
